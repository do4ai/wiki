...
이 교본은 수학 트랙의 M7번째 과목이며 8단원 40강입니다. 앞 과목인 [AI를 위한 수학](../AI를 위한 수학/index.md)를 먼저 마쳐야 이 책의 문제가 풀립니다. 전체 학습 순서와 과목별 강의 목록은 [00. 학습 순서와 커리큘럼](../00. 학습 순서와 커리큘럼/index.md)에 있습니다.
