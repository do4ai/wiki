...
이 교본은 새 커리큘럼에서 두 과목으로 갈라집니다. 토큰화와 사전학습, 추론 최적화, 정렬 등 언어모델 주제는 S12 대규모 언어모델(270~299강)이 되고, 이미지 표현과 대조학습, 멀티모달 구조는 S13 비전·언어 모델(300~324강)이 됩니다. 기존 40강은 전 강의가 스텁 상태이므로 집필 소재로만 씁니다. 전체 학습 순서는 [00. 학습 순서와 커리큘럼](../00. 학습 순서와 커리큘럼/index.md)에 있습니다.
