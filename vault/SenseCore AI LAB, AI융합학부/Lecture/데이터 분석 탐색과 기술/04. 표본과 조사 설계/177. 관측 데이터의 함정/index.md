...
**넷째 줄과 다섯째 줄이 갈리는 것이 중요합니다.** $y$ 쪽 원인은 오차를 걷어 내 정확도를 올리는데, $x$ 쪽 원인은 $x$의 움직임을 깎아 정확도를 떨어뜨립니다. 185강 문제 5에서 그 차이를 수치로 잽니다.
...
| 중간변수 | 안 합니다 | 효과를 지웁니다 |
| $y$의 원인이고 $x$와 무관 | 해도 됩니다 | 정확도가 오릅니다 |
| $x$의 원인이고 $y$와 무관 | 안 하는 편이 낫습니다 | 정확도가 내려갑니다 |
