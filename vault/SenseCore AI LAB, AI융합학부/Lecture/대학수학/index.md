...
이 교본의 내용은 새 커리큘럼에서 C1 수학의 언어(1~15강)가 됩니다. 논리, 집합, 증명, 세는 법 단원이 문제풀이 선행형으로 다시 쓰이고, 지수와 로그, 삼각함수가 여기로 들어옵니다. 복소해석과 해석학 입문 단원은 AI 트랙에서 쓰이지 않으므로 빠집니다. 이 책은 수학 트랙의 출발점이므로 선수 과목이 없습니다. 전체 학습 순서는 [00. 학습 순서와 커리큘럼](../00. 학습 순서와 커리큘럼/index.md)에 있습니다.
