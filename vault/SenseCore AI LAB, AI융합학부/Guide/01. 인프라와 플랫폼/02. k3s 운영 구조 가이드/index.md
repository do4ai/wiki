...
> **온보딩 트랙 — 1부 인프라와 플랫폼**
> 이전: [Kubernetes 기본 구조 가이드](../01. Kubernetes 기본 구조 가이드/index.md) · 다음: [k3s GitOps 운영 클러스터 초보자 가이드](../03. k3s GitOps 운영 클러스터 초보자 가이드/index.md) · 전체 경로: [시작하기 — 신입 온보딩](../../../시작하기/index.md)
