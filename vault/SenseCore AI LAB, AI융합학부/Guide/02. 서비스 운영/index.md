...
> └─ `3. 운영 절차` — 배포 이상·장애 1차 대응 손절차

서비스별 운영 절차는 각 폴더의 `3. 운영 절차`에서 다루고, 도구 자체 사용법은 [Manual](../../Manual/index.md)에서 본다. 공통 토대(k3s·GitOps·SLO 개념)는 중복하지 않고 [01. 인프라와 플랫폼](../01. 인프라와 플랫폼/index.md)과 [03. 관측과 SRE](../03. 관측과 SRE/index.md)에서 링크한다.
...
처음 보는 사람은 위 카탈로그로 전체 그림을 잡은 뒤, 맡은 서비스 폴더에 들어가 `index → 1 → 2 → 3` 순서로 읽는다.

## Page Tree

- [서비스 공통 1차 대응 절차](서비스 공통 1차 대응 절차/index.md)
...
> **온보딩 트랙 — 2부 서비스 운영**
> 이전: [Headlamp 클러스터 대시보드](../01. 인프라와 플랫폼/09. Headlamp 클러스터 대시보드/index.md) · 다음: [서비스 공통 1차 대응 절차](서비스 공통 1차 대응 절차/index.md) · 전체 경로: [시작하기 — 신입 온보딩](../../시작하기/index.md)
