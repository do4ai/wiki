...
1. **이미지 레지스트리**: prod ECR(`passv-api`) 유지 vs Harbor(`harbor.do4i.com/do4ai/passv-api`) 통일 — 결정 후 overlay `images:` 핀.
...
- 서비스 개요: [passv 서비스 가이드](../../../Guide/2. 서비스 운영/passv 서비스 가이드/index.md).
