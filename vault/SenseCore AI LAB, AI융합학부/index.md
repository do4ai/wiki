...
- [Guide](Guide/index.md)
  - [1. SCAI LAB Guide 사용법](Guide/1. SCAI LAB Guide 사용법/index.md)
  - [2. 연구실 운영 개요](Guide/2. 연구실 운영 개요/index.md)
  - [3. 계정과 접근](Guide/3. 계정과 접근/index.md)
  - [4. 연구실 업무 도구](Guide/4. 연구실 업무 도구/index.md)
  - [5. 연구/개발 환경](Guide/5. 연구-개발 환경/index.md)
  - [6. 인프라와 플랫폼](Guide/6. 인프라와 플랫폼/index.md)
    - [k3s GitOps 운영 클러스터 초보자 가이드](Guide/6. 인프라와 플랫폼/k3s GitOps 운영 클러스터 초보자 가이드/index.md)
    - [Kubernetes 기본 구조 가이드](Guide/6. 인프라와 플랫폼/Kubernetes 기본 구조 가이드/index.md)
    - [k3s 운영 구조 가이드](Guide/6. 인프라와 플랫폼/k3s 운영 구조 가이드/index.md)
    - [GitOps 운영 모델 가이드](Guide/6. 인프라와 플랫폼/GitOps 운영 모델 가이드/index.md)
    - [ArgoCD 운영 흐름 가이드](Guide/6. 인프라와 플랫폼/ArgoCD 운영 흐름 가이드/index.md)
    - [Infisical 시크릿 관리 가이드](Guide/6. 인프라와 플랫폼/Infisical 시크릿 관리 가이드/index.md)
    - [Observability 운영 가이드](Guide/6. 인프라와 플랫폼/Observability 운영 가이드/index.md)
  - [7. 서비스 운영](Guide/7. 서비스 운영/index.md)
  - [8. 데이터, 관측, 보안](Guide/8. 데이터, 관측, 보안/index.md)
    - [운영 장애 Discord 리포트 솔루션 리서치](Guide/8. 데이터, 관측, 보안/운영 장애 Discord 리포트 솔루션 리서치/index.md)
    - [k3s 운영 장애 Discord 리포트 설계](Guide/8. 데이터, 관측, 보안/k3s 운영 장애 Discord 리포트 설계/index.md)
  - [9. 협업과 커뮤니케이션](Guide/9. 협업과 커뮤니케이션/index.md)
  - [10. 장애 대응과 운영 판단](Guide/10. 장애 대응과 운영 판단/index.md)
- [Manual](Manual/index.md)
  - [1. SCAI LAB Manual 사용법](Manual/1. SCAI LAB Manual 사용법/index.md)
  - [2. 계정 발급과 회수](Manual/2. 계정 발급과 회수/index.md)
  - [3. 외부 로그인 설정](Manual/3. 외부 로그인 설정/index.md)
    - [구글로그인](Manual/3. 외부 로그인 설정/구글로그인/index.md)
    - [카카오로그인](Manual/3. 외부 로그인 설정/카카오로그인/index.md)
  - [4. 서버와 배포 작업](Manual/4. 서버와 배포 작업/index.md)
    - [ArgoCD 사용법](Manual/4. 서버와 배포 작업/ArgoCD 사용법/index.md)
    - [k3s 클러스터 접속과 GitOps 배포 점검](Manual/4. 서버와 배포 작업/k3s 클러스터 접속과 GitOps 배포 점검/index.md)
    - [Harbor 사용법](Manual/4. 서버와 배포 작업/Harbor 사용법/index.md)
  - [5. 운영 변경 작업](Manual/5. 운영 변경 작업/index.md)
    - [Ingress, 도메인, 이미지, 환경 변수 변경 절차](Manual/5. 운영 변경 작업/Ingress, 도메인, 이미지, 환경 변수 변경 절차/index.md)
  - [6. 모니터링/로그 작업](Manual/6. 모니터링-로그 작업/index.md)
    - [Grafana, Kibana, Tempo 1차 장애 확인 절차](Manual/6. 모니터링-로그 작업/Grafana, Kibana, Tempo 1차 장애 확인 절차/index.md)
    - [Alerta 사용법](Manual/6. 모니터링-로그 작업/Alerta 사용법/index.md)
  - [7. 시크릿/권한 작업](Manual/7. 시크릿-권한 작업/index.md)
    - [Infisical 시크릿 반영과 권한 변경 절차](Manual/7. 시크릿-권한 작업/Infisical 시크릿 반영과 권한 변경 절차/index.md)
